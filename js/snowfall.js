...
$(document).ready(function(){
	$(document).snowfall({
		image:"https://s2.ax1x.com/2020/01/21/1FlaVK.png", 
		flakeCount:12, 
		minSpeed:1, 
		minSize:8, 
		maxSize:20
	...
	$(document).snowfall({
		image:"https://s2.ax1x.com/2020/01/21/1FltDx.png", 
		flakeCount:12, 
		minSpeed:1, 
		minSize:8, 
		maxSize:20
	...
	$(document).snowfall({
		image:"https://s2.ax1x.com/2020/01/21/1FlNb6.png", 
		flakeCount:12, 
		minSpeed:1, 
		minSize:8, 
		maxSize:20
	...
	$(document).snowfall({
		image:"https://s2.ax1x.com/2020/01/21/1FlYK1.png", 
		flakeCount:12, 
		minSpeed:1, 
		minSize:8, 
		maxSize:20
